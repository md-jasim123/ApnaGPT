...
function ChatWindow() {
    const { prompt, setPrompt, reply, setReply, currThreadId, prevChats, setPrevChats, setNewChat, handleLogout } = useContext(MyContext); const [loading, setLoading] = useState(false);
    ...
    const getReply = async () => {
        ...
        try {
            const response = await fetch("https://apnagpt-backend-no8k.onrender.com/api/chat", options);
